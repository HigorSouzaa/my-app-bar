        ...
        <View style={styles.container}>
                ...
                <View>
                    ...
                    <View style={styles.campoInput}>
                        ...
                        <TouchableOpacity onPress={toggleShowPassword} style={{display: 'flex', justifyContent: 'center'}}>
                            <FontAwesomeIcon icon={showPassword ? faEyeSlash : faEye} size={25} color='white' />
                        </TouchableOpacity>
                    </View>
                </View>
