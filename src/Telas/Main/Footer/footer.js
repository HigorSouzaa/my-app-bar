...
export default function Footer() {
  ...
  const abrirLinkdin = () => {
    const urlLinkdin =
      "https://www.linkedin.com/in/higor-souza-555967201?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app";
    ...
    <View style={styles.container_footer}>
      ...
      <View style={styles.conteiner_links}>
        <TouchableOpacity onPress={abrirInstagram}>
          <Image source={require("../../../../assets/instagram1.png")}></Image>
        </TouchableOpacity>
        <TouchableOpacity onPress={abrirLinkdin}>
          <Image source={require("../../../../assets/linkedin1.png")}></Image>
        </TouchableOpacity>
        <TouchableOpacity onPress={abrirGitHub}>
          <Image source={require("../../../../assets/github1.png")}></Image>
        </TouchableOpacity>
      </View>
    </View>
  );
